odoo.define('theme_laze.s_offer_banner_front',function(require){
'use strict';
        ...
        if(date != 'nan') {
            ...
            timer = setInterval(function() {
                ...
                if(distance > 0 && cr.$target.find('.offer_timer_section')) {
                    ...
                    var append_data="<div class='offer_timer_section'><ul contenteditable='false'><li><span class='h3'>"+ days +"</span><label>Days</label></li><li><span class='h3'>"+hours+"</span><label>Hours</label></li><li><span class='h3'>"+minutes+"</span><label>Minutes</label></li><li><span class='h3'>"+seconds+"</span><label>Seconds</label></li></ul></div>";
