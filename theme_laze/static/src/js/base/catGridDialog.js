odoo.define('theme_laze.catGridDialog', function (require) {
"use strict";
...
let baseProduct = catGridDialog.extend(FetchProductsData, FetchCategoryData, BaseLazeQweb,{
    ...
    _initData: function(popupType, rec){
        ...
        if (popupType == "Category") {
            const CatTemp = cr._baseLazeQweb("theme_laze.dialog_catGrid_list_view_init",rec);
