odoo.define('theme_laze.offerDialog', function (require) {
"use strict";
...
let baseProduct = offerDialog.extend(FetchProductsData, BaseLazeQweb,{
    ...
    _initData: function(rec){
        var cr = this;
        var opts = this.opts;
        const CatTemp = cr._baseLazeQweb("theme_laze.dialog_prod_list_view_init",rec);
    ...
    _addProdTimer: function(ev) {
        ...
        const OfferData = {
            size:"large",
            subTemplate:webUtils.Markup($(cr._baseLazeQweb("theme_laze.dialog_timer_modal",{'perent_id': perent_id})).html()),
            fullSubTemplate:1,
            enableCoreButton:0,
            enableCoreTitle:0,
            perent_id:perent_id,
