odoo.define('theme_laze.catProductDialog', function (require) {
"use strict";

const webEditor = require('web_editor.widget');
const webUtils = require('web.utils');
const options = require('web_editor.snippets.options');
const { BaseLazeQweb, FetchProductsData, FetchCategoryData} = require("theme_laze.core_mixins");
...
let baseProduct = catProductDialog.extend(FetchProductsData, FetchCategoryData, BaseLazeQweb,{
    ...
    xmlDependencies: catProductDialog.prototype.xmlDependencies.concat([
        ...
        '/theme_laze/static/src/xml/snippets/categ_product_dialog.xml',
    ...
    _initData: function(popupType, rec){
        ...
        if (popupType == "Category") {
            ...
            const CatTemp = cr._baseLazeQweb("theme_laze.dialog_catProd_list_view_init",rec);
