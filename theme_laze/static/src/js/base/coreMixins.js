odoo.define('theme_laze.core_mixins', function (require) {
"use strict";
...
var coreData =  {
    LazeTemplateGetter:{
        _getLazeTemplate:function(module, t_name, data){
            const template = module + "." + t_name;
            return this._rpc({
                route: '/laze_template_getter',
    ...
    AjaxAddToCart:{
        _lazeAddToCart:function(params){
        ...
        _lazeMiniCart:function(){
            return ajax.jsonRpc('/shop/mini/cart', 'call', {})
        }
    },
    BaseLazeQweb:{
        _baseLazeQweb: function(template,context){
