odoo.define('theme_laze.login_popup', function (require) {
"use strict";
...
var LazeLogin =  Dialog.extend({
    template: 'theme_laze.core_front_dialog',
    xmlDependencies: Dialog.prototype.xmlDependencies.concat([
        '/theme_laze/static/src/xml/core_front_dialog.xml', ]),
    ...
    willStart:function(){
        return this._super.apply(this, arguments).then(() => {
            this.$modal.addClass("as-login-modal as-modal").removeClass("o_technical_modal");
        })
    },
    ...
    _userSignup:function(ev){
        ...
        if(logins.trim() != "" && passwords.trim() != ""
            ...
            ev.preventDefault();
            return cr._rpc({
                route: "/laze/signup/authenticate",
                params: {
                        "login":logins,
                        "name":names,
                        "password":passwords,
...
publicWidget.registry.laze_login = publicWidget.Widget.extend({
    selector:'.as-login',
    events:{
        'click':'_loginPopup'
    },
    ...
    _loginPopup:function(ev){
        ...
        cr._rpc({
            ...
            var lazeLogin = new LazeLogin(cr,{
