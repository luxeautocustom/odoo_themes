odoo.define('theme_laze.product_core', function (require) {
"use strict";
...
publicWidget.registry.as_product_details = publicWidget.Widget.extend(AjaxAddToCart, {
    ...
    start: function () {
        return this._super.apply(this, arguments).then(() => {
            var alterna_and_access = new Swiper("#as_alternative", {
                slidesPerView: 2,
                spaceBetween: 10,
                navigation: {
            ...
            var alterna_and_access = new Swiper("#as_accessory_product", {
                slidesPerView: 2,
                spaceBetween: 10,
                navigation: {
                  nextEl: ".swiper-button-next",
