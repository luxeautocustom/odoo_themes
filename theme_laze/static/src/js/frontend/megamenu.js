odoo.define('theme_laze.megamenu', function (require) {
"use strict";
...
publicWidget.registry.mega_menu = publicWidget.Widget.extend(LazeTemplateGetter, FetchProductsData, FetchCategoryData, BaseLazeQweb, {
    ...
    getMegaContent: function() {
        ...
        if (contentType == "product_mega_modal") {
        ...
        else if(contentType == "category_mega_modal"){
